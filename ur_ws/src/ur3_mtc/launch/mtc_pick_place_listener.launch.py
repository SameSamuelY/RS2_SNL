...
def generate_launch_description():
    ...
    pick_x = LaunchConfiguration('pick_x', default='-0.2')
    pick_y = LaunchConfiguration('pick_y', default='-0.2')
    pick_z = LaunchConfiguration('pick_z', default='0.05')
    place_x = LaunchConfiguration('place_x', default='0.2')
    place_y = LaunchConfiguration('place_y', default='0.2')
    place_z = LaunchConfiguration('place_z', default='0.05')
    ...
    mtc_node = TimerAction(
        ...
        actions=[
            Node(
                package='ur3_mtc',
                executable='mtc_pick_place_listener',
                name='mtc_pick_place_listener',
                output='screen',
                parameters=[
                    robot_description,
                    robot_description_semantic,
